...
namespace MyPortpolio.Controllers
{
    ...
    public class ManagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Idx,Cate,Subject,Contents,RegDate")] Manage manage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idx,Cate,Subject,Contents,RegDate")] Manage manage)
        {
            if (id != manage.Idx)
            {
                return NotFound();
        ...
        {
            return _context.Manages.Any(e => e.Idx == id);
        }
    }
}
