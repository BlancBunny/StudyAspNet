...
namespace DotNetNote.Models
{
    public class NoteRepository
    {
        ...
        public NoteRepository()
        {
            ...
            BoardLibrary.LOGGER.Info("노트 리포지토리 생성");
        }
        ...
        public void Add(Note vm)
        {
            ...
            {
                BoardLibrary.LOGGER.Error($"예외 발생 NoteReposiroty.cs - Add() : {ex.Message}");
                return; // 로깅 처리 권장 영역
        ...
        public int UpdateNote(Note vm)
        {
            ...
            {
                BoardLibrary.LOGGER.Error($"예외 발생 NoteReposiroty.cs - UpdateNote() : {ex.Message}");
            }
            return r;
        }
        ...
        public void ReplyNote(Note vm)
        {
            ...
            {
                BoardLibrary.LOGGER.Error($"예외 발생 NoteReposiroty.cs - ReplyNote() : {ex.Message}");
                return;
            }
        }
        ...
        public List<Note> GetAll(int page)
        {
            try
            {
                ...
                return conn.Query<Note>("ListNotes", parameters,
                    commandType: CommandType.StoredProcedure).ToList();
            }
            catch (System.Exception ex)
            {
                BoardLibrary.LOGGER.Error($"예외 발생 NoteReposiroty.cs - GetAll() : {ex.Message}");
                return null;
            }
        }
        ...
        public int GetCountBySearch(string searchField, string searchQuery)
        {
            try
            {
                return conn.Query<int>("SearchNoteCount", new
                {
            ...
            {
                BoardLibrary.LOGGER.Error($"예외 발생 NoteReposiroty.cs - GetCountBySearch() : {ex.Message}");
                return -1;
            }
        }
        ...
        public int GetCountAll()
        {
            ...
            {
                BoardLibrary.LOGGER.Error($"예외 발생 NoteReposiroty.cs - GetCountAll() : {ex.Message}");
                return -1;
            }
        }
        ...
        {
            return
                conn.Query<string>("Select FileName From Notes Where Id = @Id",
            ...
            int page, string searchField, string searchQuery)
        {
            ...
            return conn.Query<Note>("SearchNotes", parameters,
                commandType: CommandType.StoredProcedure).ToList();
        }
        ...
        {
            conn.Execute("Update Notes Set DownCount = DownCount + 1 "
        ...
        public Note GetNoteById(int id)
        {
            ...
            return conn.Query<Note>("ViewNote", parameters,
        ...
        {
            return conn.Execute("DeleteNote",
        ...
        public List<Note> GetNoteSummaryByCategory(string category)
        {
            ...
            return conn.Query<Note>(sql, new { Category = category }).ToList();
        }
        ...
        public void AddNoteComment(NoteComment model)
        {
            ...
            conn.Execute(sql, parameters, commandType: CommandType.Text);
        }
        ...
        {
            return conn.Query<int>(@"Select Count(*) From NoteComments 
        ...
        {
            return conn.Execute(@"Delete NoteComments 
                Where BoardId = @BoardId And Id = @Id And Password = @Password; 
                Update Notes Set CommentCount = CommentCount - 1 
                Where Id = @BoardId"
                , new { BoardId = boardId, Id = id, Password = password }
        ...
        public List<NoteComment> GetRecentComments()
        {
            ...
            return conn.Query<NoteComment>(sql).ToList();
        }
